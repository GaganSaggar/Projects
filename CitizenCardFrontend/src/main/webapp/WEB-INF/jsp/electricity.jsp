...
<html>
<head>
<title>CitizenCard | Electricity</title>
    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="electricitys"><span>Electricity</span></a></li>
          <li><a href="login_insurance.html"><span>Insurance</span></a></li>
          <li><a href="banks"><span>Bank</span></a></li>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        ...
        <div class="article">
          <div class="clr"></div>
                <h2 class="h h2">Electricity Bill</h2>
                <center>
          <form method="post" action="addElectricitys" modelAttribute="electricity">
           <p>
                <input type="text" name="username" id="username" value="${user}" readonly  class="txt" required>

              </p>
              <p>
                <input type="number" name="scnum" id="scnum" placeholder="SC Number" class="txt" required>
              </p>

              <p>
                <input type="number" name="acnum" id="acnum" placeholder="AC Number" class="txt" required>
              </p>

              <p>
                <input type="number" name="ero" id="ero" placeholder="ERO" class="txt" required>
              </p>
              ...
              <p>
                <input type="submit" name="pay" value="Pay" class="sub" >
              </p>
