...
<html>
<head>
<title>Citizen Card | Citizen</title>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        ...
        <div class="article">
          <div class="clr"></div><h2 class="h h2">Citizen Login</h2>
      <center>
          <form action="${loginUrl}" method="post" >
              <p>
                <img src="images\Julie-Professional-Round.png" alt="user" align="center" id="user">
              </p>
              <p>
<input type="text" id="inputEmail" class="txt" name="username" placeholder="username" required autofocus>              </p>

              <p>
<input type="password" id="inputPassword" class="txt" name="password" placeholder="Password" required>              </p>
              ...
              <a href="citizen_reg.html">
              <p class="newac" style="margin-left:14%;"> (or)<br>Create a New Account </p>
                </a>
              <p>
                <a href="#"><img src="images\iconmonstr-facebook-4-240 (1).png" alt="fb" class="social" align="center" ></a>

                <a href="#"><img src="images\iconmonstr-twitter-4-240.png" alt="twtr" class="social" align="center"></a>

                <a href="#"><img src="images\iconmonstr-google-plus-4-240.png" alt="g+" class="social" align="center"></a>
