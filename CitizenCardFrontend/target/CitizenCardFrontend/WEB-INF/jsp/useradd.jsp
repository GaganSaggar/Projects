  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        ...
        <div class="article">
          <div class="clr"></div>
<div class="clr"></div><h2 class="h h2"> Add Citizens Information</h2>
     <center>
          <form method="post" action="addUsers" modelAttribute="user">
              <p>
...
<input type="text" name="password" id="password"  placeholder="Enter your Password" class="txt" required>
              ...
              <p>
               ...
               <p>
                <input type="text" name="role" id="role" placeholder="Enter its role"  class="txt" required>

              </p>
              
               <p>
                <input type="text" name="enabled" id="enabled" placeholder="Enabled or not"  class="txt" required>
