...
<div class="main subpage">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          <li class="active"><a href="home"><span>Profile</span></a></li>
          ...
          <li><a href="vehicleuser"><span>Vehicles</span></a></li>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        ...
        <div class="article">
          <div class="clr"></div>
                <h2 class="h h2" style="color: #5107C0;">Welcome <strong>${user}</strong></h2>
        </div>
      </div>
      <div class="sidebar">
        <div class="clr"></div>
