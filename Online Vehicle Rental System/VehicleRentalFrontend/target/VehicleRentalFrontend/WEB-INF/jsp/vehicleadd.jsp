...
<!-- <link rel="stylesheet" href="styles/admin_post_a_vehicle.css">
...
<%@include file="styles/admin_post_a_vehicle.css" %>
			...
			<ul>
				...
				<div class="dropdown-container" style="display: block;">
					    <a href="admin_post_a_vehicle.html">
					    	<li class="select"><h2><i class="fa fa-truck"></i> Post a Vehicle</h2></li>
					    </a>
...
<!---------------------------------LISTING BOXES---------------------------------------------->
	<ul class="a">
						...
						<div class="contact_title" style="text-decoration: underline;text-transform: uppercase; font-size: 20px; margin-top: 20px; margin-bottom: 20px;">Post a Vehicle</div>
					<div class="contact_form_container">
							<form method="post" action="addVehicles" modelAttribute="vehicle">							<div style="width: 100%;">
							...
							<input type="text" class="contact_input contact_input_name inpt" placeholder="Vehicle Title" required="required" id="vehiclename" name="vehiclename">
							...
							<input type="text" class="contact_input contact_input_name inpt" placeholder="Vehicle Type" required="required" name="vehicletype" id="vehicletype">
...
<!-- 						    <div style="margin-bottom: 18px; margin-top: 20px;"><label for="vehicle_overview" style="color: black; font-weight: bold;">Mobile No. <span style="color: red;">*</span> :</label> <br>							
 -->						    <input type="hidden" class="contact_input contact_input_name inpt" placeholder="Mobile No." value="9310510577" readonly required="required" name="mobile" id="mobile">
							...
							<input type="number" class="contact_input contact_input_name inpt" placeholder="Price Per Day" required="required" name="costperday" id="costperday">
							<div class="input_border"></div></div>

							<div style="margin-bottom: 18px; margin-top: 20px; width: 48.5%; float: right;"><label for="fuel" style="color: black; font-weight: bold;">Address<span style="color: red;">*</span>:</label> <br>
							<input type="text" class="contact_input contact_input_name inpt" placeholder="Address" required="required" name="address" id="address"">
						    ...
						    <div>
							<div style="margin-bottom: 18px; margin-top: 20px; width: 48.5%; float: left;"><label for="year" style="color: black; font-weight: bold;">Vehicle No.<span style="color: red;">*</span>:</label> <br>
							<input type="number" class="contact_input contact_input_name inpt" placeholder="Vehicle No." required="required" name="vehicleno" id="vehicleno">
							<div class="input_border"></div></div>
							...
							<input type="number" class="contact_input contact_input_name inpt" placeholder="Seating Capacity" required="required" name="capacity" id="capacity">
							<div class="input_border"></div></div>
							<div class="clr">
                           </div>
						</div>
